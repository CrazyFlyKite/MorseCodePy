...
ERROR_MESSAGE3: Final[str] = 'Invalid Language - The specified language is not recognized or supported'
...
# Other
SUPPORTED_LANGUAGES: List[str] = ['english', 'spanish', 'french', 'russian', 'ukrainian']
